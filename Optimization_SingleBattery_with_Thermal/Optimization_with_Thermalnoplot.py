...
mat1 = loadmat('C:/Users/Benoit Couraud/OneDrive - Université Nice Sophia Antipolis/Lectures/localenergymarkets/localenergymarkets/python/PVPower_Demand.mat') #open a .mat file and converts it into arrays
mat2 = loadmat('C:/Users/Benoit Couraud/OneDrive - Université Nice Sophia Antipolis/Lectures/localenergymarkets/localenergymarkets/python/Buying_Selling_Price.mat')
...
#Texte=np.concatenate([(5)*np.ones((72,1)),(10)*np.ones((144,1)),(7)*np.ones((72,1))],axis=0)
# Text= np.array(pd.read_csv("Text.csv"))[:,0]
# Texte=np.zeros(288)
# n=0
# m=0
# while n<144: ## Transforme le pas de temps d'une heure en pas de temps de la demi heure
#     Texte[m]=Text[n]
#     Texte[m+1]=Text[n]
#     m=m+2
#     n=n+1
...
# Consign= np.array(pd.read_csv("Consigne.csv"))[:,0]
# Consigne=np.zeros(288)
# n=0
# m=0
# while n<144: ## Transforme le pas de temps d'une heure en pas de temps de la demi heure
#     Consigne[m]=Consign[n]
#     Consigne[m+1]=Consign[n]
#     m=m+2
#     n=n+1
