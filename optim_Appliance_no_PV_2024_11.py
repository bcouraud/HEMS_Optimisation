...
A = np.concatenate([Aeq1, Aeq2, Aeq5, np.eye(f.shape[0])], axis=0)
bl = np.concatenate([Beq1, Beq2, Beq5, lb.reshape((lb.shape[0], 1))], axis=0)
bu = np.concatenate([Beq1, Beq2,  Beq5, ub.reshape((ub.shape[0], 1))], axis=0)
